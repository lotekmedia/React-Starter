#Starter Kit for [Building Applications in React and Redux in ES6](http://www.pluralsight.com/author/cory-house) (from Cory House)

This is my version of [Cory House Starter Kit](https://github.com/coryhouse/pluralsight-redux-starter.git)

I've added only a few components and routes to have a working app from the start.  Thanks Cory!

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/lotekmedia/React-Starter.git`
3. **Make sure you're in the directory you just created.** - `cd react-starter`
